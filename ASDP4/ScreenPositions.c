 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sun Dec 27 15:25:55 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ScreenPositions
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void ScreenPositions_Outputs_wrapper(const real_T *u0,
			real_T *y0);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    ScreenPositions_Outputs_wrapper(u0, y0);
